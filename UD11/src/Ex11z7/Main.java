...
public class Main {
	...
	public static void main(String[] args) {
		 JFrame frame = new JFrame("11.6");
		    ...
		    JMenu menu = new JMenu("Profiles");
		    menubar.add(menu);
		    
		    JMenuItem item1 = new JMenuItem("Crear usuario");
		    menu.add(item1);
		    
		    JMenuItem item2 = new JMenuItem("Eliminar usuario");
		    menu.add(item2);
		    
		    JMenuItem item3 = new JMenuItem("Modificar usuario");
		    menu.add(item3);
